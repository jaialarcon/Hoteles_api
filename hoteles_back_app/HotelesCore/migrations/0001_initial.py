    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crated_at', models.DateTimeField(default=datetime.datetime(2021, 11, 3, 11, 43, 9, 960326))),
                ('updated_at', models.DateTimeField(default=datetime.datetime(2021, 11, 3, 11, 43, 9, 960326))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crated_at', models.DateTimeField(default=datetime.datetime(2021, 11, 3, 11, 43, 9, 961326))),
                ('updated_at', models.DateTimeField(default=datetime.datetime(2021, 11, 3, 11, 43, 9, 961326))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crated_at', models.DateTimeField(default=datetime.datetime(2021, 11, 3, 11, 43, 9, 961326))),
                ('updated_at', models.DateTimeField(default=datetime.datetime(2021, 11, 3, 11, 43, 9, 961326))),
                ('begin_at', models.DateTimeField(default=datetime.datetime(2021, 11, 3, 11, 43, 9, 961326))),
