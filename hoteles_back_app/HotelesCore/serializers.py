...
class PuntuacionesSerializer(serializers.ModelSerializer):
    class Meta:
        model = Puntuaciones
        fields = ('id_puntuacion', 'hotel', 'usuario','puntuacion','crated_at','updated_at')

class PublicidadSerializer(serializers.ModelSerializer):
    class Meta:
        model = Publicidad
        fields = ('id_public', 'hotel', 'servicio','detalle','costo','crated_at','updated_at','publicidad_date','publicidad_ends_at','estado')